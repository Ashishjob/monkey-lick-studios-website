  ...
  return (
    <>
      ...
      <div className="flex flex-row justify-center w-full">
        <iframe src="https://docs.google.com/presentation/d/100x6_ORM86gmwy0lh4CkMpv7H5tryB4krr_QQdJRwUo/embed?start=false&loop=true&delayms=3000" frameBorder="0" width="960" height="569" allowFullScreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>      
        </div>
      {/* <FeaturesSection />
      <PricingSection />
      <FAQSection /> */}
